...
#define RIKI_SERIAL1_GPIO_CLK           RCC_AHBPeriph_GPIOD
...
#define RIKI_SERIAL2_GPIO_CLK        	RCC_AHBPeriph_GPIOD
...
#define RIKI_SERIAL3_IRQ				USART1_IRQn
#define RIKI_SERIAL3_CLK             	RCC_APB1Periph_USART3
#define RIKI_SERIAL3_GPIO_CLK        	RCC_AHBPeriph_GPIOD 
...
#define RIKI_BATTERY_GPIO_CLK		RCC_AHBPeriph_GPIOC
